...
This repository contains addresses of all smart contracts used in the Skybase ecosystem.

Use this repository as the primary source of truth when looking for the canonical addresses of Skybase infrastructure.

## Licensing

This repository is a fork of the grove-labs/grove-address-registry. All code in this repository is licensed under the GNU Affero General Public License v3.0 (AGPL-3.0), which requires that modifications to the code must be made available under the same license. See the [LICENSE](LICENSE) file for more details.
